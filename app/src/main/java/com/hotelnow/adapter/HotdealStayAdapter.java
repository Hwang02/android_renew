...
public class HotdealStayAdapter extends ArrayAdapter<SearchResultItem> {
    Context mContext;
    String hotels = "";
    DialogAlert dialogAlert;
    List<SearchResultItem> mlist;
    DbOpenHelper dbHelper;
    HotDealHotelFragment hhf;

    public HotdealStayAdapter(Context context, int textViewResourceId, List<SearchResultItem> objects, HotDealHotelFragment hhf, DbOpenHelper dbHelper) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        finalHolder.iv_favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hhf.setLike((int) v.getTag(), finalHolder.islike);
            }
        });
