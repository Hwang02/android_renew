...
public class SearchStayAdapter extends ArrayAdapter<SearchResultItem> {
    Context mContext;
    String hotels = "";
    ...
    public SearchStayAdapter(Context context, int textViewResourceId, List<SearchResultItem> objects, DbOpenHelper dbHelper) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(position == mlist.size()-2){
            ((HotelSearchActivity)mContext).getSearch();
        }
