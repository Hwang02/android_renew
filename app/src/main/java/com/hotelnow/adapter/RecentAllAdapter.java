...
public class RecentAllAdapter extends ArrayAdapter<SearchResultItem> {
    Context mContext;
    String hotels = "";
    ...
    public RecentAllAdapter(Context context, int textViewResourceId, List<SearchResultItem> objects, DbOpenHelper dbHelper) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(entry.getHotel_id().equals("stay")) {
        ...
        finalHolder.iv_favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((RecentAllActivity)mContext).setLike((int)v.getTag(), finalHolder.islike);
            }
        });
    ...
    private class ViewHolder {
        ...
        TextView tv_rate, category, tv_nearlocation, hotel_name, tv_discount_rate, sale_price, room_count, won, tv_soldout, tv_special, hid, sdate, edate;
