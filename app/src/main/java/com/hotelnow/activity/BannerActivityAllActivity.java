...
public class BannerActivityAllActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new BannerAllAdapter(this, 0, mItems, dbHelper, "Activity");
    ...
    private void getData(){
        ...
        Api.get(CONFIG.banner_list+"?category=promotion&view=activity", new Api.HttpCallback() {
            @Override
