...
public class ReservationActivityActivity extends Activity {
    ...
    private String pid, accepted_price, ec_date, ee_date, cookie, pcode = "0", hid;
            ...
            public void onClick(View v) {
                if(!is_point_ok){
                    ...
                    if(reserve_money < Integer.parseInt(point_discount.getText().toString())){
                        ...
                        is_point_ok = false;
                        Toast.makeText(ReservationActivityActivity.this, "적립금을 확인해 주세요.", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    is_point_ok = true;
...
//                                    sub_total_price2.setText("-"+Util.numberFormat(reserve_value + coupon_value + private_money) + "원");
                    ...
                    if (data.has("products") == true) {
                        ...
                        if(products.length() > 1) {
                            ...
                            for (int i = 0; i < products.length(); i++) {
                                if(i == 0)
                                {
                                    View t = new View(ReservationActivityActivity.this);
                    ...
                    btn_go_payment.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if ((CurHourFormat.format(dt).equals("00") || CurHourFormat.format(dt).equals("01")) && checkin_date.startsWith(CurDateFormat.format(dt))) {
                                ...
                                bdialog = new DialogBookingCaution(ReservationActivityActivity.this, okClickListener, skipClickListener);
    ...
    private void setPayItem(int mPayType){
        ...
        if (mPayType == 2) {
            ...
            tv_paytype2.setTextColor(ContextCompat.getColor(ReservationActivityActivity.this, R.color.purple));;
            ...
            tv_paytype2.setTextColor(ContextCompat.getColor(ReservationActivityActivity.this, R.color.blacktxt));;
        ...
        if (mPayType == 5) {
            ...
            tv_paytype4.setTextColor(ContextCompat.getColor(ReservationActivityActivity.this, R.color.purple));;
            ...
            tv_paytype4.setTextColor(ContextCompat.getColor(ReservationActivityActivity.this, R.color.blacktxt));;
