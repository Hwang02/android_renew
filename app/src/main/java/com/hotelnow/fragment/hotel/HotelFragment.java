...
import com.hotelnow.adapter.PrivateDealHotelAdapter;
...
public class HotelFragment extends Fragment {
    ...
    public void setPrivateLike(final int position, final boolean islike, final PrivateDealHotelAdapter adapter){
